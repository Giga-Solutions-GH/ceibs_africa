    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=356)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_first_name', models.CharField(blank=True, max_length=100, null=True)),
                ('new_last_name', models.CharField(blank=True, max_length=100, null=True)),
                ('new_phone', models.PositiveIntegerField(blank=True, null=True)),
                ('code', models.CharField(max_length=6)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
